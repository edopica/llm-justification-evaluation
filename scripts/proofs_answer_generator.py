...
def main():
    ...
    prompt_file_path = os.path.join(project_root, "data", "prompts", "proof_question_prompt.txt")
    input_csv_path = os.path.join(project_root, "data", "datasets", "proofs_question_pool.csv")
    output_csv_path = os.path.join(project_root, "data", "generated_data", "proofs_answers.csv")
